...
WHERE contact_name LIKE 'M%' OR contact_name LIKE '% M%';
-- Пояснення: треба вивести ІП людей, у яких ім'я починається з буки
-- М, ('М', потім будь-які символи), або прізвище починається з букви М
-- (будь-які символи, потім пробіл, потім 'М', і потім знову будь-які символи)
